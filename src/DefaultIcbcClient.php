...
class DefaultIcbcClient
{
    ...
    public function execute($request, $msgId, $appAuthToken)
    {
    ...
    public function prepareParams($request, $msgId, $appAuthToken)
    {
    ...
    public function JSONTRANSLATE($array)
    {
    ...
    public function encodeOperations($array)
    {
